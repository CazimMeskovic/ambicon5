...
import "./digitale-buchhaltung.css"
...
export default function DigitaleDinamic({ params: { locale } }: ComponentProps) {
    ...
    const girdArray: any = [
        {
            headline: "digitalaccountancy_section_one_box_1_title",
            message: "digitalaccountancy_section_one_box_1_text",
            image: "/imgs/digital/icons/001-testing.svg",
        },
        {
            headline: "digitalaccountancy_section_one_box_2_title",
            message: "digitalaccountancy_section_one_box_2_text",
            image: "/imgs/digital/icons/002-jar.svg",
        },
        {
            headline: "digitalaccountancy_section_one_box_3_title",
            message: "digitalaccountancy_section_one_box_3_text",
            image: "/imgs/digital/icons/003-available-worldwide.svg",
        },
        {
            headline: "digitalaccountancy_section_one_box_5_title",
            message: "digitalaccountancy_section_one_box_5_text",
            image: "/imgs/digital/icons/005-chat.svg",
        },
        {
            headline: "digitalaccountancy_section_one_box_6_title",
            message: "digitalaccountancy_section_one_box_6_text",
            image: "/imgs/digital/icons/006-data-protection.svg",
        },

        {
            headline: "digitalaccountancy_section_one_box_4_title",
            message: "digitalaccountancy_section_one_box_4_text",
            image: "/imgs/digital/icons/004-analysis.svg",
        },
    ];
                            ...
                            <div className="flex flex-wrap mx-1 lg:mx-4 items-center">
                                <div className="w-full text-center">
                                    ...
                                    <h1 className=" Tittle_text_allPages">
                                        <MarkdownRenderer content={t("digitalaccountancy_title")} />
                                    </h1>
                                    <p className="smoolTextServices mt-10">
                                        {t("digitalaccountancy_subtitle")}

                                        <br className="hidden lg:block" />
                                        {t("digitalaccountancy_subtitle_part_2")}
                                    </p>
                                    ...
                                    <div className="mt-10 flex flex-wrap text-center justify-center gap-10 ">
                                        <CalendlyModalWrapper url="https://calendly.com/ambicon/">
                                            <a className="btn btn-black icon-arrow-right-white px-8 py-5 lg:py-6 mb-4 md:mb-0">
                                                {t("digitalaccountancy_termin_cta")}
                                            </a>
                                        </CalendlyModalWrapper>
                                        <Link href={`/${currentLocale}/kontakt`} className="btn btn-link icon-triangle text-gray-900 ">
                                        ...
                                        <div className="w-full lg:w-2/3 relative">
                                            <div className="relative">
                                                <Image
                                                    ...
                                                    src="/imgs/digital/digita-banner.webp"
                                                    alt="ambicon"
                                                    layout="responsive"
                                                    height={619}
                                                    width={902}
                        ...
                        <div className=" flex flex-wrap mx-2">
                            ...
                            <div className="w-full  lg:w-2/3 text-center mt-10">
                                <h2 className=" Tittle_text_allPages">
                                    <MarkdownRenderer content={t("digitalaccountancy_section_one_title")} />
                                </h2>
                                <p className="smoolTextServices mt-5">
                                    <MarkdownRenderer content={t("digitalaccountancy_section_one_subtilte")} />
                                </p>
                            </div>
                    ...
                    <div className="container mt-24 mb-24">
                        <div className="flex flex-wrap mx-2   ">
                            ...
                            <div className="w-full sm:w-5/6 lg:w-2/3 text-center mt-10">
                                <p className="font-Paragra text-[21px] leading-[32px]  text-gray-600 mt-5">
                                    <MarkdownRenderer content={t("digitalaccountancy_section_one_text")} />
                                </p>
